...
/*
 * fRitE by OffSpring/PosterBoy/Candlebox/Cracker
 */

/* This is what your bot will respond to on publics ..
 ...
 * in the configfile
 */
#define IRCNAME  	"VladBot"		/* Nick */
#define USERNAME 	"VladBot"		/* Login */
#define IRCGECOS 	"/msg VladBot !help"	/* Shown in /who */
...
/* Default filenames for logging, access etc ----------------------------
   ...
   LYRICFILE		This file is where user inputed lyrics are enterd.
...
/* Misc Settings by PB ----------------------------------------------
   ...
   GREET		Ya know that hella annoying greet on join 
			crap that Holocaine made..
   ...
   SING			Define this so the bot can sing. read the comments
			in the sing.c files for more info. Also controls
			dance.
*/
#define LOG
#define GREET
