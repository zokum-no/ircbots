...

{
	...
	fprintf( list_file, "## PosterBoy (aporter@cati.CSUFresno.EDU)\n" );
	fprintf( list_file, "#############################################\n" );
...
/* Used in bot_reply function. */
int  readln_from_a_file(char *main, char *lin)
{
	FILE *stream = main;
        char p;
        do    
