...
/* PhB extensions */
void	do_log( char *from, char *rest, char *to );
void	do_unlog( char *from, char *rest, char *to );
void	do_sendlog( char *from, char *rest, char *to );
void	do_laston( char *from, char *rest, char *to );
void	do_infoon( char *from, char *rest, char *to );
void	do_infoong( char *from, char *rest, char *to );
