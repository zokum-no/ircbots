 ...
 * in the configfile
 */
#define IRCNAME  	"Nefertari"		/* Nick */
#define USERNAME 	"Nefertari"		/* Login */
#define IRCGECOS 	"/msg Nefertari |help"	/* Shown in /who */
