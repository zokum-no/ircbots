...
typedef struct aChan
{
	...
	time_t		last_topic;		/* last time the topic got refreshed    */
#ifdef DYNCHANLIMIT
	time_t		last_limit;		/* last time we checked the userlimit   */
#endif /* DYNCHANLIMIT */
...
typedef struct aBot
{
	...
	int		connect;
	int		sock;
	union sockaddr_union ip;			/* for DCC			*/
...
typedef struct aTrivScore                                                                                                     
{                                                                                                                            
        struct          aTrivScore *next;                                                                                     
