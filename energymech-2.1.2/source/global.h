...
BEG char	executable[MAXLEN];
BEG char	configfile[MAXLEN];
BEG long	uptime;
...
BEG char	lastinfodata[80];
BEG aUser	*CurrentUser;
BEG aUser	*CurrentShit;
BEG char	currentnick[255];
BEG time_t      lastrejoin;
BEG char        lastcmds[50][100];
...
{ "MAL", "Mass action level (Max userlevel that mass functions won't affect)",
	INT_VAR, 0, NULL, 0, 100 },
{ "BANMODES", "Number of MODE -b that can be done at a time",
	INT_VAR, 4, NULL, 1, 10 },
{ "OPMODES", "Number of MODE -o that can be done at a time",
	INT_VAR, 4, NULL, 1, 10 },
{ "DALEVEL", "Deafult level to add using ADDUSER command",
	INT_VAR, 90, NULL, 1, 100 },
{ "DAOP", "Default auto-op ADDUSER",
	INT_VAR, 1, NULL, 0, 1 },
{ "DPROT", "Default protection for ADDUSER",
	INT_VAR, 1, NULL, 0, 1 },
...
{ "KS", "Toggle for kicking on banned words",
	TOG_VAR, 0, NULL, 0, 0 },
{ "SS", "Toggle for responding to certain words",
	TOG_VAR, 0, NULL, 0, 0 },
...
{ "GREET", "Toggle for the bot greeting people",
	TOG_VAR, 0, NULL, 0, 0 },
{ "CTL", "Toggle for kicking lame ass users that have control chars in there userid",
	TOG_VAR, 0, NULL, 0, 0 },
{ "SPY", "Toggle seeing who does commands",
	TOG_VAR+GLOBAL_VAR, 0, NULL, 0, 0 },
{ "IWM", "Toggle for ignoring wallops in a spymsg",
	TOG_VAR+GLOBAL_VAR, 0, NULL, 0, 0 },
{ "SERVLOG", "Toggle for logging everything the bot recieves from the server",
	TOG_VAR+GLOBAL_VAR, 0, NULL, 0, 0 },
{ "SENDLOG", "Toggle for logging everything the bot sends to the server",
	TOG_VAR+GLOBAL_VAR, 0, NULL, 0, 0 },
{ "CLOAK", "Toggle for ignoring all CTCP messages",
	TOG_VAR+GLOBAL_VAR, 0, NULL, 0, 0 },
{ "RV", "Toggle for random versions",
	TOG_VAR+GLOBAL_VAR, 0, NULL, 0, 0 },
{ "RF", "Toggle for random fingers",
	TOG_VAR+GLOBAL_VAR, 0, NULL, 0, 0 },
{ "AAWAY", "Set for setting the bot automatically away",
	INT_VAR+GLOBAL_VAR, 5, NULL, 1, 1440 },
{ "AAWAY", "Toggle for setting the bot automatically away",
	TOG_VAR+GLOBAL_VAR, 0, NULL, 0, 0 },
{ "LOG", "Toggle for deleting old logs",
	TOG_VAR+GLOBAL_VAR, 0, NULL, 0, 0 },
