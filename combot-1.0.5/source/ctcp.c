...
{	
	...
	nick = getnick( from );
     ...
     /*   send_ctcp_reply( nick, "FINGER \x2Shove your god damn finger up your ass like you do every night\x2" );*/
        return; 
}
...
void ctcp_version( char *from, char *to, char *rest )
{
  ...
  /*      send_ctcp_reply( nick, "VERSION %cGrimBot Beta %s\x2", '\x2', VERSION); */
        return;
}
...
void ctcp_clientinfo( char *from, char *to, char *rest )
{
 ...
 /*       send_ctcp_reply( nick, "CLIENTINFO \x2Who says I'm a fucking client?\x2" ); */
        return;
}
