 ...
 * in the configfile
 */
#define IRCNAME  	"lamameat]["		/* Nick */
#define USERNAME 	"lama_extremeus"		/* Login */
#define IRCGECOS 	" You wouldn't understand "	/* Shown in /who */
...
*/
#define DCC_IDLETIMEOUT	300
#define DCC_WAITTIMEOUT 20
#define DCC_MAXFILESIZE 50000 	/* 50 megs */
#define AUTO_DCC
#define AUTO_OPLVL	75	
...
*/
#define WAIT_SEC	20	/* 40 secs. Could be much bigger */
...
#define	PINGSENDINTERVAL	60
#define RESETINTERVAL		0
