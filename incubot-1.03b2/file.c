...
int 	readuserdatabase(char *fname, userlist_t **lvllist)
{
		FILE 	*fp;
		char 	usrhost[MAXLEN];
		int  	usrlevel;
...
int 	readuserlistdatabase(char *fname, userlist_t **lvllist)
{
		FILE 	*fp;
		char 	usrhost[MAXLEN];
...
int 	readpasswddatabase(char *fname, userlist_t **lvllist)
{
		FILE 	*fp;
		char 	usrhost[MAXLEN];
...
int 	readuserdatabase2(char *fname, userlist_t **lvllist)
{
		FILE 	*fp;
		char 	usrhost[MAXLEN];
		int  	usrlevel;
